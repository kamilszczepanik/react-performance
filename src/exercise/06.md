...
### It is best to put things where we will be using them that co location

There are slices of state like in the redux toolkit query for performance
optimalization - withStateSlice
