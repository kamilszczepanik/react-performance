...
context is changing array and that's why everything is rerendered

you can also split state and dispatch in context so in places you want dispatch
only the state change is not triggering rerenders
