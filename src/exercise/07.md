...
We can use sendProfileQueue and in the place where console.info is send the data
to backend then send it to grafana, we are sending it in every 5 seconds to
batch them withing this 5 seconds and send them all together
