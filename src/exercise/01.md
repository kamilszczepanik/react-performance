...
* When I want to create react native application where interaction is a priority and I want to avoid unecessary re-renders.
* Rendering huge data
* React has tools to use to speed up the application. A lot of the time the code is the same except the mini part where this is used.
